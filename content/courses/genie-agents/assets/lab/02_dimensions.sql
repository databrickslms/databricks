...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_date
...
ALTER TABLE mfg.core.dim_date ALTER COLUMN date_key
  COMMENT 'Calendar date. One row per day.';
ALTER TABLE mfg.core.dim_date ALTER COLUMN fiscal_year
...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_branch
...
ALTER TABLE mfg.core.dim_branch ALTER COLUMN region
...
ALTER TABLE mfg.core.dim_branch ALTER COLUMN state
...
ALTER TABLE mfg.core.dim_branch ALTER COLUMN channel
...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_product
...
ALTER TABLE mfg.core.dim_product ALTER COLUMN product_category
...
ALTER TABLE mfg.core.dim_product ALTER COLUMN regulatory_product_class
...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_customer
...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_account
...
ALTER TABLE mfg.core.dim_account ALTER COLUMN status
...
ALTER TABLE mfg.core.dim_account ALTER COLUMN closed_date
...
-- ============================================================================
CREATE OR REPLACE TABLE mfg.core.dim_fx_rate
...
ALTER TABLE mfg.core.dim_fx_rate ALTER COLUMN usd_rate
...
-- Row counts
-- ----------------------------------------------------------------------------
SELECT 'dim_date'     AS table_name, count(*) AS rows FROM mfg.core.dim_date
UNION ALL SELECT 'dim_branch',   count(*) FROM mfg.core.dim_branch
UNION ALL SELECT 'dim_product',  count(*) FROM mfg.core.dim_product
UNION ALL SELECT 'dim_customer', count(*) FROM mfg.core.dim_customer
UNION ALL SELECT 'dim_account',  count(*) FROM mfg.core.dim_account
UNION ALL SELECT 'dim_fx_rate',  count(*) FROM mfg.core.dim_fx_rate
ORDER BY table_name;
